  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const newProduct = {
        ...
        postedBy: {
          _type: "reference",
          _ref: userProfile?._id, // Assign logged-in vendor to the postedBy field
        },
      };
    ...
    <DashboardLayout>
      <div className="container mx-auto">
        ...
        <form onSubmit={handleSubmit}>
          <div className="mb-4">
            <label className="block ">Menu Name</label>
            <input
              type="text"
              name="name"
              value={formData.name}
          ...
          <div className="mb-4">
            <label className="block ">Menu Images</label>
            <input
              type="file"
              multiple
              accept="image/*"
...
// Fetch categories and variations from Sanity
export const getServerSideProps = async () => {
  try {
    ...
    console.error("Error fetching categories/variations:", error);
    return {
      props: {
        categories: [],
        variations: [],
