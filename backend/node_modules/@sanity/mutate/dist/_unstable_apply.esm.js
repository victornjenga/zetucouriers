import { arrify } from "./_legacy/arrify.esm.js";
import { splice, applyPatchMutation, assignId, hasId } from "./_legacy/utils.esm.js";
import { applyNodePatch, applyOp, applyPatches } from "./_legacy/utils.esm.js";
...
const empty = {}, createStore = (initialEntries) => {
  let version = 0, index = initialEntries && (initialEntries == null ? void 0 : initialEntries.length) > 0 ? Object.fromEntries(
...
//# sourceMappingURL=_unstable_apply.esm.js.map
