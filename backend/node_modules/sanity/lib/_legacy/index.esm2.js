...
import { Button } from "./generate-help-url.esm.esm.js";
import { usePaneLayout, PaneItem, PaneContent, useStructureTool, usePane, PaneHeader, PaneHeaderActions, BackLink, Pane, _DEBUG } from "./pane.esm.js";
...
function ListPane(props) {
  const { childItemId, index, isActive, isSelected, pane, paneKey } = props, { defaultLayout, displayOptions, items, menuItems, menuItemGroups } = pane, showIcons = displayOptions?.showIcons !== !1, { title } = useI18nText(pane);
