...
`, Button = React.forwardRef(function({
  ...
  const renderWrapper = React.useCallback(
    (children) => /* @__PURE__ */ jsxRuntime.jsx(Tooltip, { content: tooltipProps?.content, portal: !0, ...tooltipProps, children: /* @__PURE__ */ jsxRuntime.jsx(TooltipButtonWrapper, { children }) }),
    [tooltipProps]
  );
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(
    ui.Dialog,
    {
      ...
      animate: !0,
      ref,
      footer: (footer?.confirmButton || footer?.cancelButton) && /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { width: "full", gap: 3, justify: "flex-end", padding: 3, children: [
...
`, MenuItem = React.forwardRef(function({
  ...
  const menuItemContent = React.useMemo(() => /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { align: "center", gap: 2, children: [
    ...
    (children) => /* @__PURE__ */ jsxRuntime.jsx(Tooltip, { content: tooltipProps?.content, portal: !0, ...tooltipProps, children: /* @__PURE__ */ jsxRuntime.jsx("div", { children }) }),
    [tooltipProps]
  );
