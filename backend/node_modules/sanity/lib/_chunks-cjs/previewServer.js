...
async function writeFavicons(basePath, destDir) {
  const sanityPkgPath = (await readPkgUp__default.default({ cwd: __dirname }))?.path, faviconsPath = sanityPkgPath ? path__default.default.join(path__default.default.dirname(sanityPkgPath), "static", "favicons") : void 0;
  if (!faviconsPath)
