...
var _createContext = require("sanity/_createContext");
const ActiveWorkspaceMatcherContext = _createContext.createContext(
  "sanity/_singletons/context/active-workspace-matcher",
  null
), AddonDatasetContext = _createContext.createContext(
  "sanity/_singletons/context/addon-dataset",
  null
), CalendarContext = _createContext.createContext(
  "sanity/_singletons/context/calendar",
  void 0
), ChangeIndicatorTrackerContextStore = _createContext.createContext(
  "sanity/_singletons/context/change-indicator-tracker-store",
  null
), ChangeIndicatorTrackerContextGetSnapshot = _createContext.createContext(
  "sanity/_singletons/context/change-indicator-tracker-get-snapshot",
  null
), ColorSchemeSetValueContext = _createContext.createContext("sanity/_singletons/context/color-scheme-set-value", null), ColorSchemeValueContext = _createContext.createContext(
  "sanity/_singletons/context/color-scheme-value",
  null
), CommentInputContext = _createContext.createContext(
  "sanity/_singletons/context/comment-input",
  null
), CommentsAuthoringPathContext = _createContext.createContext(
  "sanity/_singletons/context/comments-authoring-path",
  null
), CommentsContext = _createContext.createContext(
  "sanity/_singletons/context/comments",
  null
), CommentsEnabledContext = _createContext.createContext(
  "sanity/_singletons/context/comments-enabled",
  {
    enabled: !1,
    mode: null
  }
), CommentsIntentContext = _createContext.createContext(
  "sanity/_singletons/context/comments-intent",
  void 0
), CommentsOnboardingContext = _createContext.createContext(
  "sanity/_singletons/context/comments-onboarding",
  null
), CommentsSelectedPathContext = _createContext.createContext(
  "sanity/_singletons/context/comments-selected-path",
  null
), CommentsUpsellContext = _createContext.createContext(
  "sanity/_singletons/context/comments-upsell",
  null
), ConnectorContext = _createContext.createContext(
...
), CopyPasteContext = _createContext.createContext(
  "sanity/_singletons/context/copy-paste",
  null
), DiffContext = _createContext.createContext("sanity/_singletons/context/diff", {
  path: []
}), DocumentActionPropsContext = _createContext.createContext(
  "sanity/_singletons/context/document-action-props",
  void 0
), DocumentChangeContext = _createContext.createContext(
  "sanity/_singletons/context/document-change",
  null
), DocumentFieldActionsContext = _createContext.createContext(
  "sanity/_singletons/context/document-field-actions",
  null
), DocumentIdContext = _createContext.createContext(
  "sanity/_singletons/context/document-id",
  null
), DocumentPaneContext = _createContext.createContext(
  "sanity/_singletons/context/document-pane",
  null
), DocumentSheetListContext = _createContext.createContext(
  "sanity/_singletons/context/document-sheet-list",
  void 0
), FieldActionsContext = _createContext.createContext(
...
), FormBuilderContext = _createContext.createContext(
  "sanity/_singletons/context/form-builder",
  null
), FormCallbacksContext = _createContext.createContext(
  "sanity/_singletons/context/form-callbacks",
  null
), FormFieldPresenceContext = _createContext.createContext(
  "sanity/_singletons/context/form-field-presence",
  []
), FormValueContext = _createContext.createContext(
  "sanity/_singletons/context/form-value",
  null
), FreeTrialContext = _createContext.createContext(
  "sanity/_singletons/context/free-trial",
  void 0
), GetFormValueContext = _createContext.createContext(
  "sanity/_singletons/context/get-form-value",
  null
), HoveredFieldContext = _createContext.createContext(
...
), IsLastPaneContext = _createContext.createContext(
  "sanity/_singletons/context/is-last-pane",
  !1
), LocaleContext = _createContext.createContext(
  "sanity/_singletons/context/locale",
  void 0
), MentionUserContext = _createContext.createContext(
  "sanity/_singletons/context/mention-user",
  null
), NavbarContext = _createContext.createContext(
...
), PaneContext = _createContext.createContext(
  "sanity/_singletons/context/pane",
  null
), PaneLayoutContext = _createContext.createContext(
...
const PaneRouterContext = _createContext.createContext(
...
), PortableTextMarkersContext = _createContext.createContext(
  "sanity/_singletons/context/portable-text-markers",
  []
), PortableTextMemberItemsContext = _createContext.createContext(
  "sanity/_singletons/context/portable-text-member-items",
  []
), PresenceContext = _createContext.createContext(
  "sanity/_singletons/context/presence",
  []
), PresenceTrackerContextStore = _createContext.createContext(
  "sanity/_singletons/context/presence-tracker-store",
  null
), PresenceTrackerContextGetSnapshot = _createContext.createContext(
  "sanity/_singletons/context/presence-tracker-get-snapshot",
  null
), PreviewCardContext = _createContext.createContext(
  "sanity/_singletons/context/preview-card",
  {
    selected: !1
  }
), ReferenceInputOptionsContext = _createContext.createContext(
  "sanity/_singletons/context/reference-input-options",
  {}
), ReferenceItemRefContext = _createContext.createContext(
  "sanity/_singletons/context/reference-item-ref",
  null
), ResourceCacheContext = _createContext.createContext(
  "sanity/_singletons/context/resource-cache",
  null
), ReviewChangesContext = _createContext.createContext(
  "sanity/_singletons/context/review-changes",
  null
), RouterContext = _createContext.createContext(
  "sanity/_singletons/context/router",
  null
), RouterHistoryContext = _createContext.createContext(
  "sanity/_singletons/context/router-history",
  null
), ScheduledPublishingEnabledContext = _createContext.createContext(
  "sanity/_singletons/context/scheduled-publishing-enabled",
  null
), SchedulePublishUpsellContext = _createContext.createContext(
...
), SchedulesContext = _createContext.createContext(
  "sanity/_singletons/context/schedules",
  void 0
), ScrollContext = _createContext.createContext(
  "sanity/_singletons/context/scroll",
  null
), SearchContext = _createContext.createContext(
  "sanity/_singletons/context/search",
  void 0
), SortableItemIdContext = _createContext.createContext(
  "sanity/_singletons/context/sortable-item-id",
  null
), SourceContext = _createContext.createContext("sanity/_singletons/context/source", null), StructureToolContext = _createContext.createContext(
  "sanity/_singletons/context/structure-tool",
  null
), TasksContext = _createContext.createContext(
  "sanity/_singletons/context/tasks",
  null
), TasksEnabledContext = _createContext.createContext(
  "sanity/_singletons/context/tasks-enabled",
  {
    enabled: !1,
    mode: null
  }
), TasksNavigationContext = _createContext.createContext(
  "sanity/_singletons/context/tasks-navigation",
  null
), TasksUpsellContext = _createContext.createContext(
  "sanity/_singletons/context/tasks-upsell",
  null
), TreeEditingEnabledContext = _createContext.createContext(
  "sanity/_singletons/context/tree-editing-enabled",
  {
    enabled: !1,
    legacyEditing: !1
  }
), UserColorManagerContext = _createContext.createContext(
  "sanity/_singletons/context/user-color-manager",
  null
), ValidationContext = _createContext.createContext(
  "sanity/_singletons/context/validation",
  []
), VirtualizerScrollInstanceContext = _createContext.createContext(
  "sanity/_singletons/context/virtualizer-scroll-instance",
  null
), WorkspaceContext = _createContext.createContext(
  "sanity/_singletons/context/workspace",
  null
), WorkspacesContext = _createContext.createContext(
  ...
  modalBackground: 2e3,
  spinner: 3e3
}, ZIndexContext = _createContext.createContext(
