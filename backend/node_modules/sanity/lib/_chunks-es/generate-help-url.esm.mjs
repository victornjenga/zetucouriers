...
`, Button = forwardRef(function({
  ...
  const renderWrapper = useCallback(
    (children) => /* @__PURE__ */ jsx(Tooltip, { content: tooltipProps?.content, portal: !0, ...tooltipProps, children: /* @__PURE__ */ jsx(TooltipButtonWrapper, { children }) }),
    [tooltipProps]
  );
  ...
  return /* @__PURE__ */ jsx(
    Dialog$1,
    {
      ...
      animate: !0,
      ref,
      footer: (footer?.confirmButton || footer?.cancelButton) && /* @__PURE__ */ jsxs(Flex, { width: "full", gap: 3, justify: "flex-end", padding: 3, children: [
...
`, MenuItem = forwardRef(function({
  ...
  const menuItemContent = useMemo(() => /* @__PURE__ */ jsxs(Flex, { align: "center", gap: 2, children: [
    ...
    (children) => /* @__PURE__ */ jsx(Tooltip, { content: tooltipProps?.content, portal: !0, ...tooltipProps, children: /* @__PURE__ */ jsx("div", { children }) }),
    [tooltipProps]
  );
