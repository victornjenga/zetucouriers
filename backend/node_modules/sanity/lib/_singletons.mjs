...
const ActiveWorkspaceMatcherContext = createContext(
  "sanity/_singletons/context/active-workspace-matcher",
  null
), AddonDatasetContext = createContext(
  "sanity/_singletons/context/addon-dataset",
  null
), CalendarContext = createContext(
  "sanity/_singletons/context/calendar",
  void 0
), ChangeIndicatorTrackerContextStore = createContext(
  "sanity/_singletons/context/change-indicator-tracker-store",
  null
), ChangeIndicatorTrackerContextGetSnapshot = createContext(
  "sanity/_singletons/context/change-indicator-tracker-get-snapshot",
  null
), ColorSchemeSetValueContext = createContext("sanity/_singletons/context/color-scheme-set-value", null), ColorSchemeValueContext = createContext(
  "sanity/_singletons/context/color-scheme-value",
  null
), CommentInputContext = createContext(
  ...
  null
), CommentsEnabledContext = createContext(
  ...
  void 0
), CommentsOnboardingContext = createContext(
  "sanity/_singletons/context/comments-onboarding",
  null
), CommentsSelectedPathContext = createContext(
  "sanity/_singletons/context/comments-selected-path",
  null
), CommentsUpsellContext = createContext(
...
), CopyPasteContext = createContext(
  "sanity/_singletons/context/copy-paste",
  null
), DiffContext = createContext("sanity/_singletons/context/diff", {
  path: []
}), DocumentActionPropsContext = createContext(
  "sanity/_singletons/context/document-action-props",
  void 0
), DocumentChangeContext = createContext(
  "sanity/_singletons/context/document-change",
  null
), DocumentFieldActionsContext = createContext(
  "sanity/_singletons/context/document-field-actions",
  null
), DocumentIdContext = createContext(
  "sanity/_singletons/context/document-id",
  null
), DocumentPaneContext = createContext(
  ...
  void 0
), FieldActionsContext = createContext(
  ...
  null
), FormCallbacksContext = createContext(
  "sanity/_singletons/context/form-callbacks",
  null
), FormFieldPresenceContext = createContext(
  "sanity/_singletons/context/form-field-presence",
  []
), FormValueContext = createContext(
  "sanity/_singletons/context/form-value",
  null
), FreeTrialContext = createContext(
  "sanity/_singletons/context/free-trial",
  void 0
), GetFormValueContext = createContext(
...
), PaneContext = createContext(
  "sanity/_singletons/context/pane",
  null
), PaneLayoutContext = createContext(
...
const PaneRouterContext = createContext(
...
), PortableTextMarkersContext = createContext(
...
), SchedulesContext = createContext(
  "sanity/_singletons/context/schedules",
  void 0
), ScrollContext = createContext(
  "sanity/_singletons/context/scroll",
  null
), SearchContext = createContext(
  "sanity/_singletons/context/search",
  void 0
), SortableItemIdContext = createContext(
  "sanity/_singletons/context/sortable-item-id",
  null
), SourceContext = createContext("sanity/_singletons/context/source", null), StructureToolContext = createContext(
  "sanity/_singletons/context/structure-tool",
  null
), TasksContext = createContext(
...
), TasksNavigationContext = createContext(
  "sanity/_singletons/context/tasks-navigation",
  null
), TasksUpsellContext = createContext(
  "sanity/_singletons/context/tasks-upsell",
  null
), TreeEditingEnabledContext = createContext(
  "sanity/_singletons/context/tree-editing-enabled",
  {
    enabled: !1,
    legacyEditing: !1
  }
), UserColorManagerContext = createContext(
  ...
  null
), WorkspacesContext = createContext(
