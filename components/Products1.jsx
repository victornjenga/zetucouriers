...
const TruncateParagraph = ({ text }) => {
  const truncatedText = text.split(" ").slice(0, 2).join(" ") + "...";

  return <p className="text-base text-gray-900">{truncatedText}</p>;
};
...
function Products({ product }) {
  ...
  return (
    <div className="w-[50%] md:w-[25%] px-2 md:px-4 ">
      <div className="flex  flex-col relative px-3 py-2  h-full justify-center  rounded-md border border-gray-300 dark:border-gray-800 cursor-pointer hover:bg-gray-100 hover:border-gray-200 bg-white dark:bg-black">
        ...
        <div className="mt-2 w-full justify-center items-center flex flex-col h-auto">
          ...
          <div className="justify-centre py-1 items-center flex">
            ...
            <div className=" font-semibold text-yellow-400 text-sm md:text-lg">
              Ksh {price}
            </div>
          </div>
        </div>
